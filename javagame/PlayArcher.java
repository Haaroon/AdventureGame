...
public class PlayArcher extends BasicGameState{
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		...
		shopimage = new Image("res/shopimage2.png"); //links the shop image
			...
			//list to initialise and declare the sprite movements
       		Image up1 = new Image("res/sprites/archer/ftr2_bk1.png");
       		Image up2=  new Image("res/sprites/archer/ftr2_bk2.png");
       		Image down1 = new Image("res/sprites/archer/ftr2_fr1.png");
       		Image down2=  new Image("res/sprites/archer/ftr2_fr2.png");
       		Image left1 = new Image("res/sprites/archer/ftr2_lf1.png");
       		Image left2=  new Image("res/sprites/archer/ftr2_lf2.png");
       		Image right1 = new Image("res/sprites/archer/ftr2_rt1.png");
       		Image right2=  new Image("res/sprites/archer/ftr2_rt2.png");
       		//image for the fightscene
       		Image fightscene = new Image("res/sprites/archer/fightscene-goblin.png");
