...
public class PlayKnight extends BasicGameState{
	...
	public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
		...
		Image fightscene = new Image("res/sprites/knight/fightscene-goblin.png");//image for the fightscene
